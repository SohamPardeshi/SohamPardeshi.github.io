...
export default function OnMetricsPost() {
  return (
    <article className={styles.article}>
      ...
      <p>
        My sister was a <Ghost note="There are less than 40 people in the US who get to decide the direction of kids' television. Very proud of her!">Creative Executive</Ghost> at Nickelodeon. Her job was to make the best possible kids' TV show.
      </p>
      <p>
        She told me about how she would run focus groups with children and survey their engagement to decide which shows to pick up, which to cancel, and which to rework. The process is methodical: put a pilot in front of a room of kids aged 5 to 12, use eye-tracking to measure how much they pay attention, ask them structured questions afterward, and use that data to make decisions.
      </p>
      ...
      <h4 style={{marginTop: '5px'}}>Reason #1: Numbers justify themselves</h4>
      <p>
      ...
      <p>
        If she selects a show based on her gut and it flops, that's <i>her</i> call. She owns the failure personally and has to answer to management. These people know much less about children's media than my sister. They hire her precisely because she has knowledge and good taste that they do not. But because the management knows so little, they are not able to evaluate whether my sister's instincts are good. They only observe that (1) the show flopped and (2) that my sister said it would not.
      </p>
      <p>
        On the other hand, if she selects a show because the focus group data said kids were engaged, the failure belongs to the process. The data said it would work. No one can blame her judgment, because she didn't use her judgment. She used the numbers.
      </p>
      <p>
      ...
      <p>
        This matters especially in organizations, where decisions need to be <i>justified</i> to other people. It is very difficult to walk into a room of executives and say "I think we should purchase the option to produce this show because it has a quality I can't quite articulate." It is very easy to walk into that same room and say "the engagement data shows 87% sustained attention through the third act."
      </p>
      <p>
      ...
      <p>
        This safety is genuinely useful when someone has bad judgment. If my dad were making the call instead of my sister, the studio (and the children) would be better off if he blindly followed engagement metrics. Unfortunately, these metrics can't tell the difference between my dad and my sister. They are a subsidy for bad taste, funded by good taste.
      </p>
 
      <h4 style={{marginTop: '5px'}}>Reason #2: Physics Envy</h4>
      <p>
      ...
      <p>
        <Ghost note={<>I shamelessly exploit this bias while writing this essay. Earlier, I wrote some formal definitions of optimization. Those definitions were correct, but completely irrelevant. I added them <i>specifically</i> so I could manipulate you by taking advantage of your physics envy. <br/><br/> Stop and think. Did you believe me more because I wrote that notation? If yes, then you may be susceptible to this bias.<br/><br/>That mathematical notation just repeated exactly what I said in English. It added nothing new to my argument.</>}>
          This bias has broken out of academia and ingrained itself into the public. There's a widespread, mostly unconscious belief that real knowledge is quantitative. That if we can't measure something, we don't really understand it. That the more precisely we can express a claim in numbers, the more true it is.
        </Ghost>
      </p>
      <p>
        This is a cognitive bias. Math is great, but it is not the only way to understand the world. In most cases, it is not the best way to understand the world. In many cases, it is a terrible way to understand the world.
      </p>
 
      <h4 style={{marginTop: '5px'}}>Reason #3: Quantities are easier and often good enough</h4>
      <p>
        Humans are lazy. Or maybe efficient. Whatever you want to call it. Sometimes we know a quantity is an imperfect approximation of our true goal, but we use it anyway because quantities are just ... easier.
      </p>
      <p>
        Numbers are fairly straightforward. They can be compared to other numbers. It takes only a few seconds to read a statistic and only a few minutes to convert raw data into a graph. They require far less thought and interpretation. Often, this is perfectly fine.
      </p>
      <p>
      ...
      <h4 style={{marginTop: '5px'}}>Reason #4: Some things can actually be quantified</h4>
      <p>
      ...
      <p>
        In my previous section, I intentionally left out the examples of optimizations that rely on qualities:
      </p>

      <h4 style={{marginTop: '5px'}}>(4) Personal Preference</h4>
      <p>
      ...
      <h4 style={{marginTop: '5px'}}>(5) Strategic Leadership</h4>
      <p>
        In December 1776, George Washington's Continental Army was falling apart. By every quantity available to him, the American Revolution was lost: he was outmanned, outgunned, undersupplied.
      </p>
      <p>
        If Washington were only data-driven, he would have retreated and regrouped to try and get more resources. Instead, he attacked, famously crossing the Delaware River on Christmas night.
      </p>
      <p>
      ...
      <p>
        The good news is that humans develop taste automatically. If you are an expert in some field or have paid attention to something for a long time, you probably have developed good taste in that field. 
      </p>
      <p>
        The better news is that you can develop your taste intentionally by thinking and observing. Everyone starts with bad taste. But taste develops through deliberate attention. When you produce something, sit with it and ask yourself how it feels. When you consume something, identify its qualities and compare it to other things. The more you practice exercising your taste, the better it gets.
      </p>
      ...
      <p>
        Over time, this produces a world that is increasingly afraid of failure. And I understand why. It makes sense that a business would prefer consistent small profits over high-variance large ones. If your job depends on not being wrong, you will choose the safe option every time.
      </p>
      <p>
        But as a society, we do not want this. The things we value most were not produced by people optimizing for safety. They were produced by people who had developed taste, who trusted it, and who were given the room to act on it. A world that systematically prevents people from developing and exercising taste is a world that will produce fewer and fewer of these things.
      </p>
