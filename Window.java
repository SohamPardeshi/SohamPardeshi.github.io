 ...
 * build interactive games and simulations with Java. Created at Techlab
 * Education.
 */
public class Window extends JApplet {
	...
	class WindowInstance {
		...
		public void setColor(int red, int green, int blue) {
			// Removed because Data.bound doesn't exist?
	...
	public static double random(int lo, int hi) {
		return rand.nextDouble() * (hi - lo) + lo;
	}
